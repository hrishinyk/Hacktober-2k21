    ...
    void welcome()
    {
        ...
        do
        {
            ...
            if(loginPrompt==2)
            {
                ...
                {
                    string coupon_code;
                    cout<<"Do you want to change COUPON CODE(y/n)"<<endl<<"=>";
                    char choiceCoupon;

                    cin>>choiceCoupon;
                    if(choiceCoupon=='y'||choiceCoupon=='Y')
                    {
                        cout<<"Enter COUPON CODE\n( NOTE: Coupon code should contain two digits either at the begining or at the end )"<<endl<<"=>";
                        cin>>coupon_code;
                        ofstream fout;
                        fout.open("myCoupon.txt",ios::out);
                        fout<<coupon_code;
                        fout.close();
                    }
                }
...
int main()
{
    ...
    {
        cout<<setw(75)<<"Total Bill:-  "<<(bill);
        cout<<"\n\n\t\t\t\t****Kindly pay Rs."<<bill<<"****"<<endl;
    }
    else
    {
        cout<<setw(75)<<endl<<"Discount:-  -"<<(bill*discountPercentage/100.0)<<endl;
        cout<<"-------------------------------------------------------------------------------"<<endl;
        cout<<setw(75)<<"Total Bill:-  "<<(bill-(bill*discountPercentage/100.0))<<endl;
